...
void gr_hash_3way(void *output0, void *output1, void *output2,
  ...
  for (int i = 0; i < 15 + 3; i++) {
    ...
    case WHIRLPOOL:
      ...
      break;
    case CNTurtlelite:
      CRYPTONIGHT_HASH(TURTLELITE, gr_tune_3way[gr_rotation][Turtlelite]);
      break;
    case CNTurtle:
      CRYPTONIGHT_HASH(TURTLE, gr_tune_3way[gr_rotation][Turtle]);
      break;
    case CNDarklite:
      CRYPTONIGHT_HASH(DARKLITE, gr_tune_3way[gr_rotation][Darklite]);
      break;
    case CNDark:
      CRYPTONIGHT_HASH(DARK, gr_tune_3way[gr_rotation][Dark]);
      break;
    case CNLite:
      CRYPTONIGHT_HASH(LITE, gr_tune_3way[gr_rotation][Lite]);
      break;
    case CNFast:
      CRYPTONIGHT_HASH(FAST, gr_tune_3way[gr_rotation][Fast]);
      break;
    }
    size = 64;
  }
